...
public class WineDatasetUtils {
	...
	public static String formatToMetronomeRecord(String line, double[] normalize_bases) throws Exception {
		...
		String class_id = parts[0]; // last one
...
//		outputs += "2:" + parts[6].trim() + "";
	...
	public static void main(String[] args) throws Exception {
		...
		convertToNormalizedMetronome("src/test/resources/data/uci/wine/original/wine.data.txt", "src/test/resources/data/uci/wine/oneworker/wine.mne");
