...
/**
 * WARNING: this dataset will crush you mentally and emotionally.
 * 
 * @author josh
 *
 */
public class AbaloneModelTestingTools {
...
*/
	...
	public static void scoreIrisNeuralNetworkModel(String modelFileLocation) throws Exception {
		...
		MetronomeRecordFactory rec_factory = new MetronomeRecordFactory("i:8 | o:29");
	
			
			String recs = "src/test/resources/data/uci/abalone/oneworker/abalone.mne";
	...
	public static void main(String[] args) throws Exception {
		...
		scoreIrisNeuralNetworkModel("/tmp/nn.abalone.model");
