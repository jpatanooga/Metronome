 ...
 * @since 2013-08-25
 * 
 * Modified by Adam Gibson
 */

//Conjugate Gradient, Polak and Ribiere version
//from "Numeric Recipes in C", Section 10.6.

public class CustomConjugateGradient  implements Optimizer {
	private static Logger logger = MalletLogger.getLogger(CustomConjugateGradient.class.getName());
